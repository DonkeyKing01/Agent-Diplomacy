...
_HEX_CELLS: List[Dict[str, Any]] = [
    ...
    {"id": "mt_ashencrest", "name": "北中岛", "type": "coast", "sc": True, "q": 2, "r": -2},
    ...
    {"id": "dra_cap", "name": "中央北港", "type": "coast", "sc": True, "q": 2, "r": -1},
    ...
    {"id": "aur_north", "name": "一排北村", "type": "land", "sc": True, "q": 0, "r": 0},
    ...
    {"id": "aur_port", "name": "一排码头", "type": "coast", "sc": True, "q": 0, "r": 1},
    {"id": "ferr_mine", "name": "七排北矿", "type": "land", "sc": True, "q": 1, "r": 1},
    {"id": "sol_temple", "name": "中央码头", "type": "coast", "sc": True, "q": 2, "r": 1},
    ...
    {"id": "nor_wood", "name": "中央丘陵", "type": "land", "sc": True, "q": 2, "r": 2},
    ...
    {"id": "nor_cap", "name": "中央南港", "type": "coast", "sc": True, "q": 2, "r": 3},
    ...
    {"id": "vel_hill", "name": "中央南镇", "type": "land", "sc": True, "q": 2, "r": 4},
...
HOME_CENTERS: Dict[str, List[str]] = {
    "aur": ["aur_march", "aur_port", "aur_north", "aur_cap"],
