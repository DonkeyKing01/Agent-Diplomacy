...
class Game_sessionsData(BaseModel):
    ...
    phase_index: int
    status: str
    provinces_json: str = None
    units_json: str = None
    sc_json: str = None
    nations_json: str = None
    last_orders_json: str = None
    engine: str = None
...
class Game_sessionsUpdateData(BaseModel):
    ...
    provinces_json: Optional[str] = None
    units_json: Optional[str] = None
    sc_json: Optional[str] = None
    nations_json: Optional[str] = None
    last_orders_json: Optional[str] = None
...
async def query_game_sessionss(
    ...
    """Query game_sessionss with filtering, sorting, and pagination"""
...
async def get_game_sessions(
    ...
    """Get a single game_sessions by ID"""
...
async def update_game_sessionss_batch(
    ...
    """Update multiple game_sessionss in a single request"""
...
async def update_game_sessions(
    ...
    """Update an existing game_sessions"""
...
async def delete_game_sessionss_batch(
    ...
    """Delete multiple game_sessionss by their IDs"""
...
async def delete_game_sessions(
    ...
    """Delete a single game_sessions by ID"""
